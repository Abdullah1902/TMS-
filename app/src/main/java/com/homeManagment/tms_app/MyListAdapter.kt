...
class MyListAdapter(
    ...
    maintitle: ArrayList<String>,
    subtitle: ArrayList<String>
) : ArrayAdapter<String?>(
    context, R.layout.mylist, maintitle
) {
    ...
    init {
        ...
        this.maintitle = maintitle.toTypedArray<String>()
        this.subtitle = subtitle.toTypedArray<String>()
        //        this.imgid=imgid;
    }
}